var Jdata = [
	{
		name : 'JAPA',
		description : 'Embedable test runner for Node.js',
	...
	{
		name : 'JSVIDEO URL PARSER',
		description : 'A javascript parser to extract informations like provider, channel, id, start time from YouTube, Vimeo, Dailymotion, Twitch,... urls',
