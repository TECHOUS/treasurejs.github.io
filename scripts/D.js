var Ddata = [
	...
	{
		name : "DAILY HACK",
		description : "Tiny Tiny Hacks we use in our daily life",
	...
	{
		name : "DATE FNS",
		description : "Modern JavaScript date utility library: date-fns provides the most comprehensive, yet simple and consistent toolset for manipulating JavaScript dates in a browser & Node.js.",
	...
	{
		name : "DOMPURIFY",
		description : "DOMPurify - a DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG. DOMPurify works with a secure default, but offers a lot of configurability and hooks.",
