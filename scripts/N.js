var Ndata = [
	...
	{
		name : "NEUTRALINO JS",
		description : "Portable and lightweight cross platform application development framework",
	...
	{
		name : "NETSCOPE",
		description : "A web-based tool for visualizing neural network topologies",
